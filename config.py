...
class Config:
    ...
    model_mid: str = field(default_factory=lambda: _env("MODEL_ROUTING_MID", "anthropic/claude-sonnet-4-20250514"))
    model_expensive: str = field(default_factory=lambda: _env("MODEL_ROUTING_EXPENSIVE", "anthropic/claude-opus-4-20250514"))
    model_code_generation: str = field(default_factory=lambda: _env("MODEL_CODE_GENERATION", "anthropic/claude-sonnet-4-20250514"))
